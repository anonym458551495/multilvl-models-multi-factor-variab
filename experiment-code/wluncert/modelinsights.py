...
def get_default_netcdf_string():
    possible_results = os.listdir("./results/localflow/artif/")
    default = sorted(possible_results, reverse=True)[0]
    path = os.path.join("./results/localflow/artif", default)
    print("Using results in ", path)
    return path
...
def main():
    ...
    parser.add_argument(
        ...
        default=get_default_netcdf_string(),
